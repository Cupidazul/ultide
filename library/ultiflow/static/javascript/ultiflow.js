    ...
    ultiflow.getAppVersions = async function() {
        await app.sendRequest('get_os_versions', {}, function(response) {
            ...
            return setTimeout(function() {
                ...
                try { app.versions.Browser = ((typeof(uaData.brands) !== 'undefined') ? (uaData.brands[2].brand + ' ' + uaData.highEntropyValues.uaFullVersion) : navigator.appCodeName + ' ' + navigator.appVersion); } catch (err) { console.log('err:', err); }
