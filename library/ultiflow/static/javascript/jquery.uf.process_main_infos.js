define(['app'], function(app) {
    $.widget("ultiflow.uf_process_main_infos", {
        ...
        _create: function() {
            ...
            var BtnSave = '<button id="btn_save" class="fa fa-save" style="width: 30px;font-size: 20px;"></button>';
...
<nobr><div class="buttons" style="font-size: 10px;display: inline-flex;padding-left: 5%;height: -webkit-fill-available;position: relative;text-align: center;">${BtnSave}${BtnPlay}&nbsp;${BtnSelect}</div></nobr>
`);
