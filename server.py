...
socketio = SocketIO(app, async_mode=async_mode, cors_allowed_origins=config.IO_SERVER['cors'], logger=True if (DEBUG) else False, engineio_logger=True if (DEBUG) else False)
